...
#include "TstarAnalysis/ModifiedHitFit/interface/Fourvec_Constrainer.h"
...
public:
   ...
   /**
      @brief Return the <i>do_topgluon_flag</i> parameter.
    */
...
private:
   ...
   /**
      If <b>TRUE</b>, then fit  \f$ t*\bar{t*}\ra tg\bar{t}g \f$  events. Otherwise fit
       \f$ t\bar{t} \f$  event.
    */
