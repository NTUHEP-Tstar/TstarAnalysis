//
// $Id: Lepjets_Event_Jet.cc,v 1.2 2012/02/06 16:15:25 ymtzeng Exp $
//
...
#include "TstarAnalysis/ModifiedHitFit/interface/Lepjets_Event_Jet.h"
...
//
{
   ...
   case hitfit::higgs_label:
      return 'h';
   case hitfit::lepg_label:
      return 'n';
   case hitfit::hadg_label:
      return 'N';
