...
//------------------------------------------------------------------------------
bool MuonProducer::GetPrimaryVertex()
{
...
bool MuonProducer::IsSelectedMuon( const pat::Muon& mu, const edm::Event& iEvent ) const
{
...
bool MuonProducer::IsVetoMuon( const pat::Muon& mu, const edm::Event& ) const
{
...
//   Variable caching
//------------------------------------------------------------------------------
void MuonProducer::AddMuonVariables(
   pat::Muon& mu,
...
) const
{
   ...
   TLorentzVector trgp4 = TriggerMatchP4(
         mu,
         *_triggerObjectHandle,
         _reqtrigger,
         iEvent.triggerNames(*_hltHandle)
