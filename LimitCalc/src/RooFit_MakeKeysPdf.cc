...
//   Naming definition
//------------------------------------------------------------------------------
string KeyPdfName( const string& datasetname ) { return datasetname + "key"; }
extern const string StitchKeyPdfName = "keymaster";

//------------------------------------------------------------------------------
//   Keys pdf creating
//------------------------------------------------------------------------------
RooKeysPdf* MakeSingleKeysPdf( SampleRooFitMgr* sample, const string& datasetname )
{
...
RooAddPdf* MakeFullKeysPdf( SampleRooFitMgr* sample )
{
