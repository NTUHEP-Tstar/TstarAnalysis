...
public:
  ...
  double&
  TstarMass(){return _tstarMass; }
  double&
  ChiSquare(){return _chiSquare; }
  const double&
  TstarMass() const { return _tstarMass; }
  const double&
  ChiSquare() const { return _chiSquare; }
  ...
  std::vector<FitParticle>&
  ParticleList(){ return _fitted_particle_list; }
  const std::vector<FitParticle>&
  ParticleList() const { return _fitted_particle_list; }
